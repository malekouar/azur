...
import { LivraisonsComponent } from 'app/entities/livraisons/livraisons.component';
...
describe('Component Tests', () => {
  describe('Livraisons Management Component', () => {
    let comp: LivraisonsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LivraisonsComponent, '')
        .compileComponents();
