...
import azur.support.web.tool.config.audit.AuditEventConverter;
import azur.support.web.tool.domain.PersistentAuditEvent;
...
import static azur.support.web.tool.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
