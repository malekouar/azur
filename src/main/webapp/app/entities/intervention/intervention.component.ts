...
export class InterventionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.interventionService
        ...
        .subscribe(
          (res: HttpResponse<IIntervention[]>) => this.paginateInterventions(res.body, res.headers),
  ...
  trackId(index: number, item: IIntervention) {
    return item.id;
  }
  ...
  protected paginateInterventions(data: IIntervention[], headers: HttpHeaders) {
