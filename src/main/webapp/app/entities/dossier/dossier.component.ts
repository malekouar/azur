...
export class DossierComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.dossierService
        ...
        .subscribe(
          (res: HttpResponse<IDossier[]>) => this.paginateDossiers(res.body, res.headers),
  ...
  trackId(index: number, item: IDossier) {
    return item.id;
  }
  ...
  protected paginateDossiers(data: IDossier[], headers: HttpHeaders) {
